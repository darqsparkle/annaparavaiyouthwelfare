...
//       <div className="relative mx-auto grid max-w-7xl gap-12 px-5 py-16 sm:py-20 lg:grid-cols-[1.1fr_0.9fr] lg:gap-8 lg:px-8 lg:py-28">
...
//           >
//             <span className="brand-gradient-text">{t("hero.titleLine1")}</span>
//             <br />
...
//             <span className="text-sm not-italic text-ink/50">{t("hero.taglineTranslation")}</span>
//           </motion.p>
...
//             <div className="rounded-full border-[6px] border-white bg-white p-2 shadow-2xl shadow-primary/20">
//               <img
//                 src={logo}
//                 alt={t("meta.orgNameShort")}
//                 className="h-72 w-72 rounded-full object-cover sm:h-96 sm:w-96 lg:h-[28rem] lg:w-[28rem]"
//               />
//             </div>
...
//           >
//             <span className="brand-gradient-text block text-2xl sm:text-3xl lg:text-4xl">
//               {t("hero.titleLine1")}
//             </span>

//             <span className="brand-gradient-text mt-1 block text-3xl sm:text-4xl lg:text-5xl">
//               {t("hero.titleLine2")}
//             </span>
//           </motion.h1>
...
//           animate={{ opacity: 1, scale: 1, rotate: 0 }}
//           transition={{ duration: 0.8, ease: "easeOut", delay: 0.2 }}
//           className="relative mt-6 flex items-center justify-center sm:mt-10 lg:mt-16"
//         >
//           <div className="animate-float relative">
//             <div className="absolute inset-0 -z-10 scale-110 rounded-full seal-ring opacity-20 blur-2xl" />
    ...
    <section className="relative overflow-hidden bg-bg">
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-5 py-12 sm:py-16 lg:grid-cols-[3fr_2fr] lg:gap-6 lg:px-8 lg:py-20">
        ...
        <div className="flex min-w-0 flex-col items-start justify-center">
          ...
          >
            <span className="brand-gradient-text block text-2xl sm:text-3xl lg:whitespace-nowrap lg:text-[1.8rem] xl:text-3xl 2xl:text-4xl">
              {t("hero.titleLine1")}
            </span>

            <span className="brand-gradient-text mt-1.5 block text-3xl sm:text-3xl lg:text-3xl xl:text-3xl">
              {t("hero.titleLine2")}
            </span>
          </motion.h1>
